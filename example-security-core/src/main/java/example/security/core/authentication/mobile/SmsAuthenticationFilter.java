...
public class SmsAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private String mobileParameter = SecurityBrowserConstant.DEFAULT_PARAMETER_NAME_MOBILE;
    ...
    public SmsAuthenticationFilter() {
        super(new AntPathRequestMatcher(SecurityBrowserConstant.DEFAULT_LOGIN_PROCESSING_URL_MOBILE, "POST"));
    }
