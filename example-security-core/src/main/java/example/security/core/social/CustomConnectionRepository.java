...
//
//    public CustomConnectionRepository(String userId, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
//        this.userId = userId;
...
//        List<Connection<?>> resultList = jdbcTemplate.query(selectFromUserConnection() + " where userId = ? order by providerId, rank"
...
//    }
//
//    private final JdbcConnectionRepository.ServiceProviderConnectionMapper connectionMapper = new JdbcConnectionRepository.ServiceProviderConnectionMapper();
//
