package example.security.dao.configuration;
...
import example.security.dao.properties.DbProperties;
...
public class DbConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(@Qualifier(value = "dataSource") DataSource dataSource, PageHelper pageHelper) throws Exception{
        ...
        try {
            sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:example/security/dao/mapper/**.xml"));
